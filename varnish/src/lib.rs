...
pub mod ffi {
    ...
    pub use varnish_sys::ffi::{
        ...
        VCL_MET_RECV, VCL_MET_PIPE, VCL_MET_PASS, VCL_MET_HASH, VCL_MET_PURGE, VCL_MET_MISS,
        VCL_MET_HIT, VCL_MET_DELIVER, VCL_MET_SYNTH, VCL_MET_BACKEND_FETCH,
        VCL_MET_BACKEND_REFRESH, VCL_MET_BACKEND_RESPONSE, VCL_MET_BACKEND_ERROR,
        VCL_MET_INIT, VCL_MET_FINI, VCL_MET_TASK_B, VCL_MET_TASK_C, VCL_MET_TASK_H,
    };
}
